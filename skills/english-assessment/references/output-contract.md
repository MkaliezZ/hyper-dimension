...
- 听力还需 audio_ref、transcript_ref、speaker/accent 与播放条件；口语还需互动角色、追问规则与观察量规；图片需原创或授权记录。
- 参考题型时另存 public_format_source_url，不保存样题内容。每题必须说明“这题测什么”，并检查答案唯一性。

## 作答 response 与报告 report

- response：attempt_id、student_ref、item_id/version、start/end、raw_answer_ref、hints、media_quality、scorer_draft、evidence_span_refs、teacher_decision、decision_reason、audit_refs
